  ...
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
      ...
      <ol style="line-height: 1.8; color: #333;">
        <li><a href="${vars.appUrl}/auth" style="color: #2563eb; text-decoration: none;">${t.step1}</a></li>
        <li>${t.step2}</li>
        <li>${t.step3}</li>
      </ol>
...
function generateChangeHtmlContent(t: any, vars: Record<string, string>): string {
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
      ...
      <div style="text-align: center; margin: 35px 0;">
        <a href="${vars.authorizationUrl}" style="background-color: #2563eb; color: white; padding: 14px 32px; text-decoration: none; border-radius: 6px; display: inline-block; font-weight: 600; font-size: 16px;">${t.button}</a>
      </div>
