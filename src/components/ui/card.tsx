  ...
  "text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        glow: "glass-card shadow-card hover:shadow-glow",
        "glow-cyan": "glass-card shadow-card hover:shadow-glow-cyan",
        "glow-purple": "glass-card shadow-card hover:shadow-glow-purple",
